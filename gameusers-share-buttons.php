...
if (!class_exists('Game_Users_Share_Buttons')) {
    ...
    class Game_Users_Share_Buttons
    {
        ...
        public function __construct()
        {
            ...
            register_uninstall_hook(__FILE__, array( 'Game_Users_Share_Buttons::uninstall' ));
        ...
        {
            return '<div id="gameusers-share-buttons" data-theme="' . $themeNameId . '"></div>';
        }
        ...
        public function optionHead($hook)
        {
            if ($hook === 'settings_page_gameusers-share-buttons') {
                ...
                wp_enqueue_style('jquery-confirm', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.2.3/jquery-confirm.min.css', array(), '3.2.3');
                wp_enqueue_script('jquery-confirm', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.2.3/jquery-confirm.min.js', array('jquery'), '3.2.3');

                wp_enqueue_style('bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', array(), '3.3.7');

                wp_enqueue_style('ladda-bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/ladda-bootstrap/0.9.4/ladda-themeless.min.css', array(), '0.9.4');
                wp_enqueue_script('ladda-bootstrap-spin', 'https://cdnjs.cloudflare.com/ajax/libs/ladda-bootstrap/0.9.4/spin.min.js', array(), '0.9.4');
                wp_enqueue_script('ladda-bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/ladda-bootstrap/0.9.4/ladda.min.js', array(), '0.9.4');
        ...
        public function ajaxSaveTheme()
        {
            ...
            try {
                ...
                if (isset($_POST['themeNameIdPrev']) && $_POST['themeNameIdPrev'] !== $themeNameId) {
                    $directoryPathBefore = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'themes' . DIRECTORY_SEPARATOR . $_POST['themeNameIdPrev'];
                ...
                if (isset($_POST['themeNameIdPrev'])) {

                    $keyNumber = array_search($_POST['themeNameIdPrev'], $editThemesArr);
        ...
        public function ajaxSetTopBottomTheme()
        {
            ...
            try {
                ...
                if ($_POST['type'] !== 'top' && $_POST['type'] !== 'bottom') {
        ...
        public function ajaxSaveOption()
        {
            ...
            try {
                ...
                if ($_POST['twitterApiType'] === 'digitiminimi.com/count.jsoon') {
                    $jsonArr['twitterApiType'] = 'digitiminimi.com/count.jsoon';
                } else {
                    $jsonArr['twitterApiType'] = '';
                }

                if (preg_match('/^(http|https):\/\/([A-Z0-9][A-Z0-9_-]*(?:\.[A-Z0-9][A-Z0-9_-]*)+):?(\d+)?\/?/i', $_POST['rssUrl'])) {
                    $jsonArr['rssUrl'] = $_POST['rssUrl'];
                } else {
                    $jsonArr['rssUrl'] = '';
                }
                ...
                file_put_contents($path, json_encode($jsonArr));
        ...
        public function ajaxChangePlan()
        {
            ...
            try {
                ...
                if ($_POST['plan'] !== 'free' && $_POST['plan'] !== 'premium' && $_POST['plan'] !== 'business') {
