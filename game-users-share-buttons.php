...
class Game_Users_Share_Buttons
{
    ...
    {
        wp_enqueue_script('game-users-share', GAME_USERS_SHARE_BUTTONS_PLUGIN_URL . '/js/share-bundle.min.js', array('jquery'), '1.1.2', true);
    }
    ...
    public function optionHead($hook)
    {
        if ($hook === 'settings_page_game-users-share-buttons') {
            ...
            wp_enqueue_script('game-users-option', GAME_USERS_SHARE_BUTTONS_PLUGIN_URL . '/js/option-bundle.min.js', array('jquery'), '1.1.2', true);
