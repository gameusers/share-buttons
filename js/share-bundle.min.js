...
var PLUGIN_URL = exports.PLUGIN_URL = function () {
  ...
  var directoryName = 'gameusers-share-buttons';
...
var GameUsersShareButtons = exports.GameUsersShareButtons = function () {
  ...
  _createClass(GameUsersShareButtons, [{
    ...
    value: function styleType1Ver1() {
      ...
      var countPaddingTop = GameUsersShareButtons.styleAddPx(this.jsonObj.countPaddingTop);
      var countPaddingRight = GameUsersShareButtons.styleAddPx(this.jsonObj.countPaddingRight);
      var countPaddingBottom = GameUsersShareButtons.styleAddPx(this.jsonObj.countPaddingBottom);
      var countPaddingLeft = GameUsersShareButtons.styleAddPx(this.jsonObj.countPaddingLeft);
    ...
    value: function themeType1Ver1(url, uploadImageActive) {
      ...
      Object.keys(this.jsonObj.share).forEach(function (key) {
        ...
        _this.code += '<div class="' + _this.className + '-box" id="gameusers-share-buttons-' + shareName + '" data-count="' + shareCount + '">';
        ...
        var imageSrc = themeUrl + '/' + themeName + '-' + themeId + '/' + shareName + '.' + shareImageExtension;
    ...
    value: function themeType2Ver1(url, uploadImageActive) {
      ...
      Object.keys(this.jsonObj.share).forEach(function (key) {
        ...
        _this2.code += '<div class="' + _this2.className + '-box" id="gameusers-share-buttons-' + shareName + '" data-count="' + shareCount + '">';
    ...
    value: function renderAllShareButtons() {
      ...
      xhrOption.onload = function () {
        if (xhrOption.readyState === 4 && xhrOption.status === 200) {
          ...
          // const elementArr = document.querySelectorAll(`${that.containerSelector}#gameusers-share-buttons`);
          var elementArr = [].concat(_toConsumableArray(document.querySelectorAll(that.containerSelector + '#gameusers-share-buttons')));
          var elementArrCount = elementArr.length;
            ...
            xhr.onload = function () {
              if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                  ...
                  var elementDivArr = [].concat(_toConsumableArray(element.querySelectorAll('[id^=gameusers-share-buttons-]')));

                  elementDivArr.forEach(function (elementDiv) {
                    var elementCopy = elementDiv;
                    var shareId = elementDiv.id.replace(/gameusers-share-buttons-/g, '');
              ...
              if (elementArrCount >= loopCount) {
                ...
                if (that.importGoogleFontsArr.length > 0) {
                  ...
                  var fonts = that.importGoogleFontsArr.join('|');

                  var elementGoogleFonts = document.querySelector('#gameusers-share-buttons-google-fonts');
    ...
    value: function countApply(type) {
      ...
      var elementArr = [].concat(_toConsumableArray(document.querySelectorAll(this.containerSelector + '#gameusers-share-buttons-' + type)));
